...
public class AccountEx {
    public static void main(String[] args) {
        ...
        List<Account> nonEmptyAccounts = filter(accounts, num -> num.getBalance() > 0);

        List<Account> accountsWithTooMuchMoney = filter(accounts, l -> (l.isLocked() && l.getBalance() >= 100_000_000));
