...
/**
 * You need to implement a method that returns a prepared stream for detecting bad words.
 * The method has two parameters:
 *
 * a text in which all words are divided by single whitespaces;
 * a list of bad words.
 * The returned stream should contain dictionary ordered (i.e., sorted lexicographically)
 * elements that do not repeat.
 */
